...
export const portfolioItems: PortfolioItem[] = [
  ...
  // Colecionáveis
  { id: 8,  slug: 'col-rei-trono',         title: 'Colecionável — Rei no Trono',   src: '/gallery/col-rei-trono.png',          hoverSrc: null, category: 'collectibles', aspect: '1/1', alt: 'Estatueta colecionável de rei em trono dourado com detalhes elaborados' },
  { id: 9,  slug: 'col-michael-jackson',   title: 'Colecionável — Michael Jackson',src: '/gallery/col-michael-jackson.png',   hoverSrc: null, category: 'collectibles', aspect: '3/4', alt: 'Estatueta colecionável de Michael Jackson — Smooth Criminal, pintada à mão' },
  { id: 10, slug: 'col-broly',             title: 'Colecionável — Broly',          src: '/gallery/col-broly.png',              hoverSrc: null, category: 'collectibles', aspect: '3/4', alt: 'Estatueta colecionável Broly Dragon Ball com base de lava iluminada' },
  { id: 11, slug: 'col-nightwing',         title: 'Colecionável — Nightwing',      src: '/gallery/col-nightwing.png',          hoverSrc: null, category: 'collectibles', aspect: '3/4', alt: 'Estatueta colecionável Nightwing DC Comics em pose de acção' },
  ...
  { id: 15, slug: 'col-conjunto-1',        title: 'Colecionáveis — Conjunto I',    src: '/gallery/col-conjunto-1.png',         hoverSrc: null, category: 'collectibles', aspect: '4/3', alt: 'Conjunto de figuras colecionáveis estilo chibi em exposição' },
  { id: 16, slug: 'col-conjunto-2',        title: 'Colecionáveis — Conjunto II',   src: '/gallery/col-conjunto-2.png',         hoverSrc: null, category: 'collectibles', aspect: '4/3', alt: 'Conjunto de figuras colecionáveis Inside Out pintadas à mão' },
  // Placeholders

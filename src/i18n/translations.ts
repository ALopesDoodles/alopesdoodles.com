...
const pt: Translations = {
  ...
  hero: {
    ...
    subtitle: 'Mini-eu personalizados, gravação laser, tabletop e colecionáveis. Cada peça é única, feita com atenção ao detalhe e paixão pelo ofício.',
    cta: 'Ver Portfólio',
  ...
  services: {
    ...
    miniEu:       { label: 'Mini-eu',              description: 'Bonecos personalizados estilo Funko, impressos em resina 3D, que te representam a ti ou o teu pet — com a tua profissão, desporto, hobbies ou memórias. Inclusivos por natureza.' },
  ...
  portfolio: {
    ...
    filter: { all: 'Todos', miniEu: 'Mini-eu', laser: 'Laser', tabletop: 'Tabletop', collectibles: 'Colecionáveis', cosplay: 'Cosplay', custom: 'Customizáveis' },
    works: 'trabalhos',
  ...
  contact: {
    ...
    subjectPlaceholder: 'Mini-eu, gravação, colecionável…', messagePlaceholder: 'Descreve o teu projeto…',
...
const es: Translations = {
  ...
  services: {
    ...
    miniEu:       { label: 'Mini-yo',              description: 'Muñecos personalizados estilo Funko, impresos en resina 3D, que te representan a ti o a tu mascota — con tu profesión, deporte, hobbies o recuerdos. Inclusivos por naturaleza.' },
...
const en: Translations = {
  ...
  services: {
    ...
    miniEu:       { label: 'Mini-me',              description: 'Custom Funko-style figurines, 3D resin printed, that represent you or your pet — your profession, sport, hobbies or memories. Inclusive by design.' },

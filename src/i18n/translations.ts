...
const pt: Translations = {
  ...
  seo: {
    ...
    home:      { title: 'A.Lopes Doodles — Mini-eu Personalizados, Gravação Laser e Colecionáveis em Portugal', description: 'Bonecos mini-eu personalizados estilo Funko, gravação laser e colecionáveis feitos à mão em Portugal. Inclusivos, únicos e com história. Encomendas personalizadas.' },
    portfolio: { title: 'Portfólio — A.Lopes Doodles', description: 'Galeria de mini-eu personalizados, gravação laser, tabletop e colecionáveis. Cada peça é única, feita em Portugal.' },
    ...
    contact:   { title: 'Contacto — A.Lopes Doodles', description: 'Entra em contacto para orçamentos e encomendas personalizadas de mini-eu, gravação laser ou colecionáveis.' },
  },
  faq: {
